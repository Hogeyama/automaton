...
main = do
        let --dfa = Automaton { states      = ["q0","f"]
            ...
            dfa = powersetConstruction nfa
        print $ ""    `isAcceptedBy` nfa == ""    `isAcceptedBy` dfa
        print $ "0"   `isAcceptedBy` nfa == "0"   `isAcceptedBy` dfa
        print $ "01"  `isAcceptedBy` nfa == "01"  `isAcceptedBy` dfa
        print $ "010" `isAcceptedBy` nfa == "010" `isAcceptedBy` dfa
